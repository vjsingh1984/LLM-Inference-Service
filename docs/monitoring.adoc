...
image::monitoring-architecture.png[Monitoring Architecture,800,600]
...
image::dashboard-pages.png[Dashboard Pages,700,500]
...
image::health-score.png[Health Score,600,400]
...
image::alert-flow.png[Alert Flow,600,500]
...
image::performance-tracking.png[Performance Tracking,700,500]
...
image::optimization-flow.png[Optimization Flow,600,400]
